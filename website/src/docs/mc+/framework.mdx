...
![A schematic depicting how AI systems can be composed of multiple models and datasets](./images/modular-cards.png)

Figure 1: a modular view of how AI systems are composed of models and datasets.

## ...to reflect the AI lifecycle.
...
Figure 2: A system diagram of the AI lifecycle. The numbered arrows represent the following processes:
